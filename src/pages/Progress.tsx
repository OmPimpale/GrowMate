    ...
    <>
      <Layout>
        <div className="p-5">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <div className="flex-1">
                ...
                <select
                  ...
                  className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:ring-2 focus:ring-deep-purple focus:border-transparent bg-white dark:bg-gray-700 text-gray-800 dark:text-white"
                >
          ...
          >
            <div className="bg-white dark:bg-gray-800 rounded-tr-2xl rounded-bl-2xl p-6 shadow-lg">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-tr-2xl rounded-bl-2xl p-6 shadow-lg">
              <div className="flex items-center justify-between">
                ...
                <div className="p-3 bg-orange-100 dark:bg-orange-900 rounded-tr-2xl rounded-bl-2xl">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-tr-2xl rounded-bl-2xl p-6 shadow-lg">
              <div className="flex items-center justify-between">
                ...
                <div className="p-3 bg-emerald-100 dark:bg-emerald-900 rounded-tr-2xl rounded-bl-2xl">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-tr-2xl rounded-bl-2xl p-6 shadow-lg">
              <div className="flex items-center justify-between">
                ...
                <div className="p-3 bg-blue-100 dark:bg-blue-900 rounded-tr-2xl rounded-bl-2xl">
          ...
          >
            ...
            <div className="space-y-4">
              {habitStats.map((stat) => (
                <div key={stat.id} className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700 rounded-tr-2xl rounded-bl-2xl">
