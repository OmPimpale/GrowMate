      ...
      <Layout>
        <div className="p-5 max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            {stats.map((stat, index) => (
              <motion.div
                ...
                className="bg-white dark:bg-gray-800 rounded-tr-2xl rounded-bl-2xl p-6 shadow-lg hover:shadow-xl transition-shadow"
              >
                <div className="flex items-center justify-between">
                  ...
                  <div className={`p-3 rounded-tr-2xl rounded-bl-2xl ${stat.color}`}>
          ...
          <motion.div
            ...
            className="bg-white dark:bg-gray-800 rounded-tr-2xl rounded-bl-2xl p-6 shadow-lg mb-8"
          >
            <div className="flex items-center justify-between mb-6">
              ...
              <Link
                to="/habits"
                className="bg-deep-purple text-white px-4 py-2 rounded-tr-xl rounded-bl-xl hover:bg-purple-800 transition-colors font-medium flex items-center text-inter"
              >
            ...
            {habits.length === 0 ? (
              <div className="text-center py-12">
                ...
                <Link
                  to="/habits"
                  className="bg-deep-purple text-white px-6 py-3 rounded-tr-2xl rounded-bl-2xl hover:bg-purple-800 transition-colors font-medium text-inter"
                >
              ...
              <div className="space-y-4">
                {habits.slice(0, 5).map((habit) => {
                  ...
                  return (
                    <div
                      key={habit.id}
                      className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700 rounded-tr-2xl rounded-bl-2xl"
                    >
                      ...
                      <div className="flex items-center">
                        ...
                        <div
                          className={`w-6 h-6 rounded-full flex items-center justify-center ${isCompleted
                            ? 'bg-emerald-500'
          ...
          >
            <Link
              to="/habits"
              className="bg-gradient-to-r from-deep-purple to-purple-600 text-white p-6 rounded-tr-2xl rounded-bl-2xl hover:from-purple-600 hover:to-purple-700 transition-all transform hover:scale-105"
            >
            ...
            <Link
              to="/progress"
              className="bg-gradient-to-r from-teal to-blue-500 text-white p-6 rounded-tr-2xl rounded-bl-2xl hover:from-blue-500 hover:to-blue-600 transition-all transform hover:scale-105"
            >
            ...
            <Link
              to="/settings"
              className="bg-gradient-to-r from-emerald-500 to-green-500 text-white p-6 rounded-tr-2xl rounded-bl-2xl hover:from-green-500 hover:to-green-600 transition-all transform hover:scale-105"
            >
